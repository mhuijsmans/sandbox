...
boost::shared_ptr<sink_t> init_logging_asynchronous_sink() {
	...
	sink->set_formatter(
			expr::stream << "Level: " << expr::attr<severity_level>("Severity")
...
int BoostSinkAsyncTest() {
	boost::shared_ptr<sink_t> sink = init_logging_asynchronous_sink();

...
void init_logging_SinksUnlocked()
{
...
int BoostSinksUnlockedTest() {
	init_logging_SinksUnlocked();
...
TEST(BoostSinksUnlockedTest, testUsingDefaults) {
	EXPECT_EXIT(BoostSinksUnlockedTest(), ::testing::ExitedWithCode(0),
			"Success");
}

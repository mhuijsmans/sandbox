...
/**
 * Main entry point for the application to interact with process engine. It
 * maintains single <code>RuntimeManager</code> instance that is the actual
...
public class ProcessEngineService {
	...
	/**
	 * Initializes process engine by creating <code>RuntimeEngine</code>
	 * instance will all assets deployed.
	 */
	public void init() {
        if (runtimeManager == null) {
        	// The persistenceUnitName is also defined in the META-INF persistenc.xml
        	final String persistenceUnitName = "org.mahu.proto.jbpm6";
            RuntimeEnvironment environment = RuntimeEnvironmentBuilder.getDefault()
                    ...
                    .addAsset(ResourceFactory.newClassPathResource("extendedHumanTask.bpmn"), ResourceType.BPMN2)
	...
	public Collection<org.kie.api.definition.process.Process> getProcesses() {
		if (runtimeManager == null) {
			throw new IllegalStateException(
					"RuntimeManager not initialized, did you forget to call init?");
		}

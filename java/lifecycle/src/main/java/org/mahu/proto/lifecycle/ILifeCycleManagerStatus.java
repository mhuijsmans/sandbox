...
public interface ILifeCycleManagerStatus {
    ...
    /**
     * Get the number of time services have been started. Both successful and
     * not successful are counted. Counter is stepped as last action in a
     * procedure.
     * 
    ...
    /**
     * @return number of uncaught exceptions from services that have been
     *         forwarded. When an uncaught exception is detected, services are
     *         restarted. Because service can use multiple threads, multiple
     *         exception can happen at the same time. ServersStartCunt indicated
     *         number of start/restarts.
     */
